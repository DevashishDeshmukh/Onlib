...
function ViewBook() {
    ...
    const getfeedback = () => {
      ...
      axios.get("http://localhost:3001/viewissuebook").then((response) => {
  ...
  fontSize: "20px"}} className= "button" onClick={getfeedback}>Issued Books List</button>      
  ...
  color: "#fff"}}>ISBN</th>
                          <th className="thbn" style={{  backgroundColor: "rgb(45, 178, 219)",
  color: "#fff"}}>Borrower Name</th>
                          <th className="thbn" style={{  backgroundColor: "rgb(45, 178, 219)",
  color: "#fff"}}>Borrower Phone no.</th>
                          <th className="thbn" style={{  backgroundColor: "rgb(45, 178, 219)",
  color: "#fff"}}>Borrower Address</th>
                         </tr>
                      </thead>
                      <tbody>
  ...
  border: "1px solid rgb(27, 3, 65)"}}>{res.ISBN}</td>
                              <td className="tdas" style={{padding: "5px", backgroundColor: "rgb(171, 211, 246)",
  border: "1px solid rgb(27, 3, 65)"}}>{res.borrowname}</td>
                              <td className="tdas" style={{padding: "5px", backgroundColor: "rgb(171, 211, 246)",
  border: "1px solid rgb(27, 3, 65)"}}>{res.borrownum}</td>
                              <td className="tdas" style={{padding: "5px", backgroundColor: "rgb(171, 211, 246)",
  border: "1px solid rgb(27, 3, 65)"}}>{res.borrowadd}</td>
                              </tr>
                            )}   
